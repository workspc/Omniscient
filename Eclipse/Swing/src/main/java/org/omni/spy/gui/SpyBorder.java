...
public class SpyBorder extends AbstractBorder {
	...
	SpyBorder(Color color) {
		this(color, 4, 8, 7);
	}

	SpyBorder(Color color, int thickness, int radii, int pointerSize) {
	...
	SpyBorder(Color color, int thickness, int radii, int pointerSize, boolean left) {
